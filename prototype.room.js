                    ...
                    { 
                        ...
                        {                        
                            if(skLairs && skLairs.length > 0)
                            {
                                ...
                                {
                                    this.addToSpawnQueue({role: 'skAttacker', targetRoom: remoteRoomId}, true);
                                }
                                //Healer
                            ...
                            {
                                this.addToSpawnQueue({role: 'skRanger', targetRoom: remoteRoomId}, true);
                            }
                        }
                        else
                        {
